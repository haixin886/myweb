      ...
      try {
        ...
        if (data) {
          setChannelData({
            ...
            fee_rate: data.fee_rate.toString(),
          });
        }
      } catch (error) {
        console.error("Error fetching channel data:", error);
        toast.error("获取渠道信息失败");
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-2xl font-semibold">编辑支付渠道</h1>
        </div>
        <Card className="p-6">
...
export default EditPaymentChannelPage;
