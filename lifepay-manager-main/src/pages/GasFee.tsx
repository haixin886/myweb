    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-4 pt-20 space-y-4">
        ...
        <div className="space-y-4 bg-blue-100 rounded-xl p-4">
          <div>
            <div className="text-gray-600 mb-2">燃气户号</div>
            <Input
              placeholder="请输入燃气户号"
              value={account}
          ...
          <div>
            <div className="text-gray-600 mb-2">户主姓名</div>
            <Input
              placeholder="请输入户主姓名"
              value={customerName}
        ...
        <div className="flex justify-between items-center text-sm">
          <div className="flex items-center">
            ...
            <span className="text-gray-500 ml-2">优惠 {(parseFloat(customAmount || "0") * 0.05).toFixed(2)}元</span>
          </div>
        ...
        <div className="flex justify-between items-center text-base">
          <span>合计:</span>
          <span className="text-orange-500">$ {((parseFloat(customAmount || "0") * 0.95) / 7.5).toFixed(2)} USDT</span>
        </div>
